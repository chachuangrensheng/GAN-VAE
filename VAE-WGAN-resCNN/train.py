...
from models1 import VAE_GAN,Discriminator
# nvidia-smi -l 0.2
...
if __name__=='__main__':
    ...
    # 绘制损失曲线
    plot_loss(prior_loss_list, 'models1_prior_loss0.png')  # 先验损失误差
    plot_loss(recon_loss_list, 'models1_recon_loss0.png')  # 重建损失误差
    plot_loss(gan_loss_list, 'models1_gan_loss0.png')   # GAN损失误差
